...
Compilation options: -a ../../../../faust/faustMinimal.h -lang cpp -i -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a ../../../../faust/faustMinimal.h -lang cpp -i -es 1 -mcd 16 -single -ftz 0");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fThen1 = fSlow4 + fRec5[1] + fSlow5 * fTemp2;
			float fRec6 = ((iTemp3) ? fTemp4 : fThen1);
